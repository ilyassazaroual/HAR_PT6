...
CC=nvcc -D_GLIBCXX_USE_CXX11_ABI=0 ../Common/lib/common.a -I../Common/include
#CC=pgc++ 
...
filterImage.o: filterImage.cu imageProcessing.h
	$(CC) -g -c filterImage.cu  -I/usr/include/libxml2
